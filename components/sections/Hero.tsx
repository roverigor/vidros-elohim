          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <a
                ...
                className="inline-flex items-center justify-center gap-3 bg-[#25D366] hover:bg-[#20c05a] text-white font-bold px-7 py-3.5 rounded-xl transition-all shadow-lg shadow-[#25D366]/20 text-sm"
              >
