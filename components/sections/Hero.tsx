          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <a
                ...
                className="inline-flex items-center justify-center gap-3 bg-white hover:bg-white/90 text-[#1a2347] font-bold px-7 py-3.5 rounded-xl transition-all shadow-lg shadow-white/10 text-sm"
              >
              ...
              <a
                href="#portfolio"
                className="inline-flex items-center justify-center gap-2 glass border border-white/20 hover:border-white/30 text-white font-medium px-7 py-3.5 rounded-xl transition-all text-sm"
              >
                Ver Trabalhos
              </a>
            </div>
