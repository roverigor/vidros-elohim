            ...
            >
              ...
              <div className="flex flex-col flex-1 p-4">
                ...
                <a
                  ...
                  className="mt-4 flex items-center justify-center gap-2 bg-white/10 hover:bg-white border border-white/30 hover:border-white text-white/80 hover:text-[#1a2347] text-xs font-semibold py-2 px-3 rounded-lg transition-all duration-300"
                >
