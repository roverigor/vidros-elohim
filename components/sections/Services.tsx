          ...
          {SERVICES.map((service) => (
            ...
            >
              ...
              <div className="flex flex-col flex-1 p-4">
                <h3 className="font-semibold text-white text-sm mb-1.5 leading-tight group-hover:text-white transition-colors">
                  {service.title}
                </h3>
                ...
                <a
                  ...
                  className="mt-4 flex items-center justify-center gap-2 bg-[#25D366]/15 hover:bg-[#25D366] border border-[#25D366]/40 hover:border-[#25D366] text-[#25D366] hover:text-white text-xs font-semibold py-2 px-3 rounded-lg transition-all duration-300"
                >
